...
public class FTUdpClientSR {
	...
	private List<PacketInWindow> window;
	private int numberACKs;
	...
	void sendFile() {
		try {
			...
			window = new LinkedList<PacketInWindow>();
			...
			System.out.println("Bytes Transfered:"+ byteCount + " Bytes");
			System.out.println("Packets Transfered: "+ (byteCount / BlockSize) + " Packets");
			System.out.println("ACKS Received: "+numberACKs);
			System.out.println("Total Time: "+ (endTime -initialTime) +"ms");
